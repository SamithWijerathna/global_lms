...
function MaterialViewer({
  ...
  useEffect(() => {
    // Client-side expiry check (for immediate UI feedback)
    if (
    ...
    // Server-side check for videos (expiry + view limit)
    if (
  ...
  // Expired view (all material types)
  if (isExpired) {
    return (
  ...
  // View limit reached (videos only)
  ...
  if (selectedClass) {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-8">
          <h1 className="text-3xl font-bold">{selectedClass.class_title}</h1>
              ...
              >
                ...
                <CardFooter className="absolute bottom-0 z-30 w-full bg-white/30 backdrop-blur-md">
                  <div className="flex flex-col gap-2 w-full p-4">
                    ...
                    <Button
                      fullWidth
                      color={isExpired || isPending ? "default" : "primary"}
                    ...
                    >
                      <div className="space-y-6">
                        ...
                        <Card className="bg-default-100 p-5">
                          {bankChoice === "commercial" ? (
                            <>
                              ...
                              <p>
                                <strong>Account Name:</strong> R A S T
                                Rajapaksha
                              </p>
                              <p>
                                <strong>Account Number:</strong> 802 092 806 9
                              </p>
                              <p>
                                <strong>Branch:</strong> Pilimathalawa
                              </p>
                            </>
                          ) : (
                            <>
                              <p>
                                <strong>Bank:</strong> Hatton National Bank
                              </p>
                              <p>
                                <strong>Account Name:</strong> R A S T
                                Rajapaksha
                              ...
                              <p>
                                <strong>Account Number:</strong> 141020146041
                              </p>
                              <p>
                                <strong>Branch:</strong> Pilimathalawa
                              </p>
                        ...
                        <div>
                          ...
                          <label className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-xl cursor-pointer bg-default-50 hover:bg-default-100">
